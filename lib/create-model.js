 ...
 *   1. should have some shortcut methods to access default EmmoModel
 */
...
function createModel(em, modelName, modelDef) {
  ...
  /**
   * correct values's type
   *
   * @example
   * // the age/id will be converted to number type
   * User.fix({ nick: 'foo', age: '5', id: '40' })
   *
   * @static
   * @param {object}          data
  ...
  /**
   * correct specified value's type
   *
   * @example
   * // only age will be converted to number
   * User.fixProperty({ nick: 'foo', age: '5', id: '40' }, 'age')
   *
   * @static
   * @param {object}    data
   * @param {string}    name
   ...
   * @example
   * // full validation
   * User.validate({ nick: 'foo', age: 22 })
   * // or specified name/names only:
   * User.validate({ nick: 'foo', age: 22 }, 'age')
   *
   * @static
   * @param {object}          data
   * @param {string|string[]} [names]
   ...
   *
   * @example
   * User.validateProperty({ nick: 'foo', age: 22 }, 'nick')
   *
   * @static
   * @param {object}    data
   * @param {string}    name
  ...
  /**
   * save record into particular database (insert or update base on auto increment column)
   * 
   * @example
   * User.saveIn('db1', { nick: 'foo' })
   *
   * @static
  ...
  /**
   * save record (insert or update base on auto increment column)
   *
   * @example
   * User.save({ nick: 'foo' })
   *
  ...
  /**
   * update a particular cell in table of particular database
   *
   * @example
   * // to update user's age to 22 which id equals 1
   * User.cellIn('db1', 'age', 22, 1)
   *
   * @static
   * @param {string}      database
   * @param {string}      field
  ...
  var modelFuncRe = /^function \(modelName[,|\)]/;

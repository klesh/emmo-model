...
describe('SQL Query Builder Test', function() {
  ...
  it('INSERT STATEMENT', function() {
    ...
    should(builder.sql).be.exactly('INSERT INTO "Users" ("nick","password") VALUES ($1,$2);');
  ...
  it('UPDATE STATEMENT', function() {
    ...
    //console.log(builder.sql, builder.values);
    should(builder.sql).be.exactly('UPDATE "Users" SET "id"=$1, "age"="age"+$2;');
    should(builder.values).be.deepEqual([ 1, 10 ]);
